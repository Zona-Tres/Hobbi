  ...
  return (
    <section>
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        { /* Illustration */}
        <div className="absolute inset-0 -mx-28 rounded-t-[3rem] pointer-events-none overflow-hidden" aria-hidden="true">
          ...
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none max-md:text-center" data-aos="fade-down">
                ...
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-slate-900/80 via-slate-800 to-slate-700/80 pb-3">Recupera lo perdido, vuelve a ser el dueño de tu identidad y datos al conectar con otros en internet.</h3>
                ...
                <div className="mt-8 max-md:mx-auto space-y-2">
                  <button className={`space-x-2 text-sm font-medium text-slate-50 rounded border bg-slate-900 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 1 ? 'border-slate-700 opacity-50' : 'border-purple-700 shadow shadow-purple-500/25'}`} onClick={() => setTab(1)}>
                    <svg className="inline shrink-0 fill-purple-700 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                      <path d="M14 0a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12Zm0 14V2H2v12h12Zm-3-7H5a1 1 0 1 1 0-2h6a1 1 0 0 1 0 2Zm0 4H5a1 1 0 0 1 0-2h6a1 1 0 0 1 0 2Z" />
                    </svg>
                    <span>Sin necesidad de compartir tu información personal.</span>
                  </button>
                  <button className={`space-x-2 text-sm font-medium text-slate-50 rounded border bg-slate-900 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 2 ? 'border-slate-700 opacity-50' : 'border-purple-700 shadow shadow-purple-500/25'}`} onClick={() => setTab(2)}>
                    <svg className="inline shrink-0 fill-purple-700 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                      <path d="M2 6H0V2a2 2 0 0 1 2-2h4v2H2v4ZM16 6h-2V2h-4V0h4a2 2 0 0 1 2 2v4ZM14 16h-4v-2h4v-4h2v4a2 2 0 0 1-2 2ZM6 16H2a2 2 0 0 1-2-2v-4h2v4h4v2Z" />
                    </svg>
                    <span>Conecta con los demás a través de tus pasatiempos y logros.</span>
                  </button>
                  <button className={`space-x-2 text-sm font-medium text-slate-50 rounded border bg-slate-900 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${tab !== 3 ? 'border-slate-700 opacity-50' : 'border-purple-700 shadow shadow-purple-500/25'}`} onClick={() => setTab(3)}>
                    <svg className="inline shrink-0 fill-purple-700 mr-3" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                      <path d="M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8ZM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1Z" />
                    </svg>
                    <span>Lleva tus datos siempre contigo usando la tecnología NFT.</span>
                  </button>
                </div>
              </div>
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative w-48 h-48 flex justify-center items-center">
                      ...
                      >
                        ...
                        <img src={LogoImg} width={80} height={80} priority alt="Hobbi" />
                      </Transition>
                      <Transition
                        show={tab === 2}
                        className="absolute"
