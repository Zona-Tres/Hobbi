...
import FeatureImg01 from "/images/feature-image-01.png"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/60 via-slate-800 to-slate-900/60 pb-4">
              Una nueva forma de conectar
            </h2>
            <p className="text-lg text-slate-800">
              Únete a hobbi y conecta con personas que compartan tu interés
              alrededor del mundo.
            </p>
          </div>
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              Haz nuevas amistades conectándote con personas que
                              compartan los mismos gustos. La nueva película que
                              acabas de ver, ese juego que acabas de terminar o
                              aquel emocionante libro que iniciaste a leer.
                            </p>
                          </div>
                        </div>
                        <div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <svg
                  className="shrink-0 fill-purple-700"
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                >
                ...
                <h4 className="font-medium text-slate-900">
                  Se dueño de tu perfil
                </h4>
              </div>
              <p className="text-sm text-slate-700">
                Se dueño de tu perfil y de tu información en la red social de
                hobbi con un NFT dinámico. Un certificado digital de pertenencia
                en blockchain.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-700">
                Crea tu cuenta sin comprometer tu información personal.
                Utilizando la tecnología blockchain del protocolo de Internet
                Computer.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-700">
                Comparte y conecta con otras personas mediante tus logros en
                plataformas digitales como: Xbox, PlayStation, Spotify, Libros,
                Netflix entre otros.
              </p>
            </div>
          </div>
