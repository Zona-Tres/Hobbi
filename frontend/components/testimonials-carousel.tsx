      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/80 via-slate-700 to-slate-900/80 pb-4">
              Spot issues faster
            </h2>
                ...
                <HighlighterItem className="swiper-slide h-auto group/slide">
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      />
                      <div className="grow">
                        <div className="text-slate-200 font-bold text-lg mb-1">
                          Anonymous User
                        </div>
