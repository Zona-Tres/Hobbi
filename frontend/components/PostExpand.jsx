        ...
        <div className="border-t border-[#B577F7] pt-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              value={newComment}
              onChange={(e) =>
                infoUser.name ? setNewComment(e.target.value) : alert("Connect")
              }
              placeholder={
                infoUser.name ? "Write a comment..." : "Login to comment"
              }
            ...
            {postData.comments
              ...
              .map((comment) => (
                <div
                  ...
                  className="bg-[#0D1117] border border-[#161B22] p-4 rounded-lg"
                >
                  {/* Date and author */}
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="relative ml-auto">
                      ...
                      {menuComment && comment.commentId === selectedComment && (
                        <div
                          ref={menuRef}
                          className="absolute right-0 mt-2 w-40 bg-[#161B22] text-white shadow-lg rounded-lg z-10"
                        >
                          <button
