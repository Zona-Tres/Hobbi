            ...
            <div className="flex flex-col bg-purple-900 rounded-md p-4 w-full space-y-4">
                ...
                <div className="flex flex-row w-full rounded-md p-2 bg-purple-300 space-x-2">
                    ...
                    <div className="flex flex-col">
                        <p className="font-bold">Cristina started playing Animal Crossing: New Horizons</p>
                        <p className="text-sm">Me encanta! Pero no puedo conseguir hierro :c</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full rounded-md p-2 bg-purple-300 space-x-2">
                    ...
                    <div className="flex flex-col">
                        <p className="font-bold">Zin recommended you Octopath Traveler II</p>
