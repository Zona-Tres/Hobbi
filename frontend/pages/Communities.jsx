        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-[#0E1425] rounded-lg p-6 w-96">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-[#FDFCFF]">
                Create Community
              </h2>
              <button
                onClick={() => {
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-1/2 bg-[#B577F7] text-white px-4 py-2 rounded-md hover:bg-[#9B5FD9] transition-colors mt-4 ${
            ...
            {communities.map((community) => (
              ...
              >
                ...
                <div className="flex flex-col w-full ml-3 gap-1">
                  ...
                  <button
                    onClick={() =>
                      (window.location.href = `/community/${community.canisterId}`)
                    }
