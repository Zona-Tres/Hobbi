          ...
          <div className="bg-[#0E1425] rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              <p className="text-white mb-4">
                {selectedPostDetails?.Ok.metadata.body}
              </p>
              ...
              <div className="border-t border-[#B577F7] pt-4">
                  ...
                  {Array.isArray(selectedPostDetails?.Ok?.comments)
                    ? selectedPostDetails.Ok.comments.map((comment) => (
                        <div
                          ...
                          className="bg-[#0D1117] border border-[#161B22] p-4 rounded-lg shadow-md"
                        >
                          {/* Header: Autor + Fecha */}
                          ...
                          <div className="flex gap-4">
                            <button
                              ...
                              onClick={() =>
                                handleLikeComments(comment.commentId)
                              }
                            >
                              <svg
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleDislikeComments(comment.commentId)
                              }
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" && handleSubmitComment(e)
                    }
                  />
                  <button
