...
import Illustration from '@/public/images/building.png'
        ...
        <div className="py-12">
          <div className="max-w-3xl mx-auto text-center pb-12">
            <div className='flex items-center justify-center my-10'>
              <Image src={Illustration} alt="building" />
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/90 via-slate-800 to-slate-900/80 pb-4">Apoyado por grandes proyectos</h2>
            <p className="text-xl font-bold mt-8 text-slate-700">Hobbi nace en Zona Tres, una comunidad de creadores en web3 en América Latina y está siendo construido con la tecnología y apoyo del ecosistema de Internet Computer.</p>
          </div>
        </div>
      </div>
