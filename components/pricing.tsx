      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-800 to-slate-900 pb-3">Pricing plans</div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/90 via-slate-800 to-slate-900/80 pb-4">Flexible plans and features</h2>
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-4 xl:-mx-6 text-sm [&>div:nth-of-type(-n+4)]:py-6 [&>div:nth-last-of-type(-n+4)]:pb-6 max-md:[&>div:nth-last-of-type(-n+4)]:mb-8 max-md:[&>div:nth-of-type(-n+4):nth-of-type(n+1)]:rounded-t-3xl max-md:[&>div:nth-last-of-type(-n+4)]:rounded-b-3xl md:[&>div:nth-of-type(2)]:rounded-tl-3xl md:[&>div:nth-of-type(4)]:rounded-tr-3xl md:[&>div:nth-last-of-type(3)]:rounded-bl-3xl md:[&>div:nth-last-of-type(1)]:rounded-br-3xl [&>div]:bg-slate-900 [&>div:nth-of-type(4n+1)]:bg-transparent max-md:[&>div:nth-of-type(4n+5)]:hidden max-md:[&>div:nth-of-type(4n+2)]:order-1 max-md:[&>div:nth-of-type(4n+3)]:order-2 max-md:[&>div:nth-of-type(4n+4)]:order-3 max-md:md:[&>div:nth-of-type(n)]:mb-0 [&>div:nth-of-type(4n+3)]:relative before:[&>div:nth-of-type(4n+3)]:absolute before:[&>div:nth-of-type(4n+3)]:-inset-px before:[&>div:nth-of-type(4n+3)]:rounded-[inherit] before:[&>div:nth-of-type(4n+3)]:border-x-2 before:[&>div:nth-of-type(3)]:border-t-2 before:[&>div:nth-last-of-type(2)]:border-b-2 before:[&>div:nth-of-type(4n+3)]:border-purple-500 before:[&>div:nth-of-type(4n+3)]:-z-10 before:[&>div:nth-of-type(4n+3)]:pointer-events-none">
                ...
                <div className="pb-5 md:border-b border-purple-800">
                  ...
                  <div className="max-md:text-center">
                    <div className="inline-flex items-center whitespace-nowrap">
                      ...
                      <div className="text-sm text-slate-700 font-medium ml-2">Yearly <span className="text-teal-500">(-20%)</span></div>
                    </div>
                  </div>
                </div>
              </div>
              { /* Pro price */}
              <div className="px-6 flex flex-col justify-end">
                <div className="grow pb-4 mb-4 border-b border-purple-800">
                  ...
                  <div className="mb-1">
                    <span className="text-lg font-medium text-slate-200">$</span><span className="text-3xl font-bold text-slate-50">{annual ? '24' : '29'}</span><span className="text-sm text-slate-200 font-medium">/mo</span>
                  </div>
                  <div className="text-slate-200">Everything at your fingertips.</div>
                </div>
                <div className="pb-4 border-b border-purple-800">
                  <a className="btn-sm text-slate-900 bg-gradient-to-r from-white/80 via-white to-white/80 hover:bg-white w-full transition duration-150 ease-in-out group" href="#0">
                    Get Started <span className="tracking-normal text-purple-800 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                  </a>
                </div>
              </div>
              { /* Team price */}
              <div className="px-6 flex flex-col justify-end">
                <div className="grow pb-4 mb-4 border-b border-purple-800">
                  ...
                  <div className="mb-1">
                    <span className="text-lg font-medium text-slate-200">$</span><span className="text-3xl font-bold text-slate-50">{annual ? '49' : '54'}</span><span className="text-sm text-slate-200 font-medium">/mo</span>
                  </div>
                  <div className="text-slate-200">Everything at your fingertips.</div>
                </div>
                <div className="pb-4 border-b border-purple-800">
              ...
              <div className="px-6 flex flex-col justify-end">
                <div className="grow pb-4 mb-4 border-b border-purple-800">
                  ...
                  <div className="mb-1">
                    <span className="text-lg font-medium text-slate-200">$</span><span className="text-3xl font-bold text-slate-50">{annual ? '79' : '85'}</span><span className="text-sm text-slate-200 font-medium">/mo</span>
                  </div>
                  <div className="text-slate-200">Everything at your fingertips.</div>
                </div>
                <div className="pb-4 border-b border-purple-800">
              ...
              { /* # Usage */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 font-medium mt-4">Usage</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-400 font-medium mt-4 md:hidden">Usage</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-400 font-medium mt-4 md:hidden">Usage</div>
              </div>
              ...
              { /* Social Connections */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Social Connections</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              { /* Custom Domains */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Custom Domains</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">User Role Management</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              { /* External Databases */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">External Databases</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              { /* Custom Connection */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Custom Connection</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Advanced Deployment Options</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              { /* Extra Add-ons */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Extra Add-ons</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center h-full border-b border-purple-800 py-2 text-slate-300">
                  <svg className="shrink-0 fill-purple-800 mr-3" xmlns="http://www.w3.org/2000/svg" width="12" height="9">
              ...
              { /* Admin Roles */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Admin Roles</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center border-b border-purple-800 py-2 text-slate-400 max-md:hidden">
              ...
              { /* Deploy and Monitor */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Deploy and Monitor</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center border-b border-purple-800 py-2 text-slate-400 max-md:hidden">
              ...
              { /* Enterprise Add-ons */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Enterprise Add-ons</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center border-b border-purple-800 py-2 text-slate-400 max-md:hidden">
              ...
              { /* Premium Support */}
              <div className="px-6 flex flex-col justify-end">
                <div className="py-2 text-slate-700 border-b border-purple-800">Premium Support</div>
              </div>
              <div className="px-6 flex flex-col justify-end">
                <div className="flex items-center border-b border-purple-800 py-2 text-slate-400 max-md:hidden">
