      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/60 via-slate-800 to-slate-900/60 pb-4">Faster. Smarter.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900">Configurable</h4>
              </div>
              <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900">Adaptable</h4>
              </div>
              <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            { /* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900">Authorization</h4>
              </div>
              <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
            { /* Feature */}
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-900">Building</h4>
              </div>
              <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
            </div>
          </div>
