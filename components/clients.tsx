      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-12 md:py-16">
          <div className="overflow-hidden">
            ...
            <div className="clients-carousel swiper-container relative before:absolute before:inset-0 before:w-32 before:z-10 before:pointer-events-none before:bg-gradient-to-r before:from-purple-500 after:absolute after:inset-0 after:left-auto after:w-32 after:z-10 after:pointer-events-none after:bg-gradient-to-l after:from-purple-500">
              <div className="swiper-wrapper !ease-linear select-none items-center">
                { /* Carousel items */}
                <div className="swiper-slide w-auto text-slate-900">
