      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-purple-800/80 via-slate-800 to-slate-900/80 pb-4">Why trust us?</h2>
            <p className="text-lg text-slate-800">Many desktop publishing packages and web page editors now use lorem ipsum as their default model text, and a search will uncover many web sites still in their infancy.</p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-800 to-slate-900 pb-6">API Authorization</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    <svg className="shrink-0 fill-purple-800" xmlns="http://www.w3.org/2000/svg" width="16" height="16">
                    ...
                    <h4 className="font-medium text-purple-800">Discussions</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Team views</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Powerful search</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
            ...
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-800 to-slate-900 pb-6">User Management</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                { /* Feature */}
                <div>
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Notifications</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Integrations</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
            ...
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-800 to-slate-900 pb-6">Standard Security</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Privacy</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Data export</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
                { /* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-purple-800">Real-time sync</h4>
                  </div>
                  <p className="text-sm text-slate-700">Login box must find the right balance for the user convenience, privacy and security.</p>
                </div>
              </div>
