      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-900/60 via-slate-800 to-slate-700/60 pb-4" data-aos="fade-down">Hobbi</h1>
            <p className="text-lg text-slate-900 mb-8" data-aos="fade-down" data-aos-delay="200">Track media and connect with people all around the world.</p>
